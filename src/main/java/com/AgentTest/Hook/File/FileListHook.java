...
public class FileListHook implements Hook {
    ...
    public void hookMethod(CtClass ctClass){
        ...
        try {
            ...
            CtMethod list = ctClass.getMethod("list", "()[Ljava/lang/String;");

            if (list !=null){

                list.insertBefore("com.AgentTest.Hook.File.FileHook.checkFile($0);");
            }
